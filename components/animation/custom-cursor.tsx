...
export function CustomCursor() {
  ...
  return (
    <>
      <motion.div
        className="pointer-events-none fixed left-0 top-0 z-[999] h-2.5 w-2.5 -translate-x-1/2 -translate-y-1/2 rounded-full bg-cyan-200 shadow-[0_0_18px_rgba(34,211,238,0.95)]"
      ...
      <motion.div
        ...
        animate={{
          ...
          borderColor: active ? "rgba(103,232,249,0.92)" : "rgba(103,232,249,0.46)"
        }}
        style={{ x: ringX, y: ringY }}
      >
        <motion.span
          className="absolute inset-0 rounded-full bg-[radial-gradient(circle,rgba(34,211,238,0.18),transparent_62%)]"
